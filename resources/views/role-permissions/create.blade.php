...
@section('title', 'Tambah Mapping Role Permission')
@section('page-title', 'Tambah Mapping Role Permission')
@section('page-subtitle', 'Attach permission ke role')
  ...
  @can('manage-users')
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
      <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-semibold text-gray-900">Form Mapping Role Permission</h3>
      </div>

      <form method="POST" action="{{ route('role-permissions.store') }}" class="p-6 space-y-6">
        @csrf
        ...
        <div>
          ...
          <select id="role_id" name="role_id" class="w-full border border-gray-300 rounded-lg px-3 py-2" required>
